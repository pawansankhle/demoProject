...
private static Logger logger= LoggerFactory.getLogger(FiqlParser.class);
    public static final String OR = ",";
    public static final String AND = ";";
	public static final String rightBraket = "]";
   ...
   @Override
    ...
    private TypeInfoObject parseType(String originalName, String setter, String value) throws SearchParseException {
        ...
        try {
        	...
        	logger.error("Error Inside  @class :"+this.getClass().getName()+" @Method :parseType()"+e.getMessage());
            return null;
        }
            ...
            if (Date.class.isAssignableFrom(valueType)) {
                ...
                if (ownerBean == null || isPrimitiveOrEnum) {
                    ...
                    try {
                        ...
                        logger.error("Error Inside  @class :"+this.getClass().getName()+" @Method :parseType()"+ex.getMessage());
                        throw new SearchParseException("Cannot convert String value \"" + value
        ...
        try {
           ...
           Date date;
            ...
            date =new Date(Long.parseLong(value));
           	...
           	{
           	 logger.error("Error Inside  @class :"+this.getClass().getName()+" @Method :convertToDate()"+e.getMessage());
           ...
           logger.error("Error Inside  @class :"+this.getClass().getName()+" @Method :convertToDate()"+e.getMessage());
            ...
            try {
                ...
                logger.error("Error Inside  @class :"+this.getClass().getName()+" @Method :convertToDate()"+e1.getMessage());
    ...
    private String getSetter(String setter) {
        int index = setter.indexOf(".");
        if (index != -1) {
            return setter.substring(0, index);
        } else {
            return setter;
        }
    }
...
@Override
        ...
        private T createTemplate(String setter) throws SearchParseException {
            try {
                ...
                logger.error("Error Inside  @class :"+this.getClass().getName()+" @Method :createTemplate()"+e.getMessage());
