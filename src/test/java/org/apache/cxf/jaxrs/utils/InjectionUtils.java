...
public final class InjectionUtils {
        ...
        if (Proxy.class.isInstance(resourceObject)) {
            for (Class<?> c : resourceObject.getClass().getInterfaces()) {
             ...
             LOG.severe(ex.getMessage());
              LOG.severe("Error Inside  @class :"+InjectionUtils.class.getName()+" @Method :checkProxy()"+ex.getMessage());
    ...
    public static void injectFieldValue(final Field f, 
        ...
        try {
          ...
          LOG.severe(ex.getMessage());
           LOG.severe("Error Inside  @class :"+InjectionUtils.class.getName()+" @Method :injectFieldValue()"+ex.getMessage());
        ...
        return AccessController.doPrivileged(new PrivilegedAction<Object>() {
			...
			public Object run() {
                ...
                try {
                  ...
                  LOG.severe("Error Inside  @class :"+InjectionUtils.class.getName()+" @Method :extractFieldValue()"+ex.getMessage());
                    reportServerError("FIELD_ACCESS_FAILURE", 
                                      f.getType().getName());
                }
                return null;
    ...
    public static void injectThroughMethod(Object requestObject,
        ...
        LOG.severe("Error Inside  @class :"+InjectionUtils.class.getName()+" @Method :injectThroughMethod()"+ex.getMessage());
          LOG.severe(ex.getMessage());
    ...
    public static Object extractFromMethod(Object requestObject,
        ...
        try {
          ...
          LOG.severe("Error Inside  @class :"+InjectionUtils.class.getName()+" @Method :extractFromMethod()"+ex.getMessage());
          LOG.severe(ex.getMessage());
            reportServerError("METHOD_ACCESS_FAILURE", method.getName());
        } catch (Exception ex) {
          LOG.severe("Error Inside  @class :"+InjectionUtils.class.getName()+" @Method :extractFromMethod()"+ex.getMessage());
    ...
    public static <T> T handleParameter(String value, 
        ...
        LOG.severe("Error Inside  @class :"+InjectionUtils.class.getName()+" @Method :handleParameter()"+ex.getMessage());
          LOG.severe(ex.getMessage());
    ...
    private static <T> T evaluateFactoryMethod(String value,
        ...
        LOG.severe("Error Inside  @class :"+InjectionUtils.class.getName()+" @Method :evaluateFactoryMethod()"+ex.getMessage());
          LOG.severe(ex.getMessage());
    ...
    public static Object handleBean(Class<?> paramType, Annotation[] paramAnns, 
        ...
        LOG.severe("Error Inside  @class :"+InjectionUtils.class.getName()+" @Method :handleBean()"+ex.getMessage());
         LOG.severe(ex.getMessage());
     ...
     //CHECKSTYLE:ON    
        ...
        if (type != null) {
            try {
                ...
                LOG.severe("Error Inside  @class :"+InjectionUtils.class.getName()+" @Method :injectIntoCollectionOrArray()"+ex.getMessage());
              LOG.severe(ex.getMessage());
    ...
    public static <T> Object convertStringToPrimitive(String value, Class<?> cls) {
        ...
        if (cls.isPrimitive()) {
            ...
            try {
              ...
              LOG.severe("Error Inside  @class :"+InjectionUtils.class.getName()+" @Method :convertStringToPrimitive()"+ex.getMessage());
              LOG.severe(ex.getMessage());
